        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('daftar.store')}}">
                    ...
                    <textarea type="text" class="form-control" name="alamat_lengkap" required="" placeholder="Masukan Alamat Lengkap"></textarea>
                   ...
                   <input type="text" class="form-control" name="asal_smp" required="" placeholder="Asal SMP">
